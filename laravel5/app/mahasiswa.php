...
class mahasiswa extends Model
{
    ...
    public function pengguna() //membuat fungsi dengan nama pengguna
    {
        ...
        //sintaks ini menghubungkan antara model mahasiswa dengan model pengguna, yang artinya kita bisa mengakses model pengguna melalui model mahasiswa. 
        //jadi isi dai tabel pengguna bisa kita tampilkan melalui model mahasiswa, begitu juga kebalikannya.
    }
